...
import com.kevin.activitytracker.payload.request.LoginRequest;
import com.kevin.activitytracker.payload.request.SignupRequest;
import com.kevin.activitytracker.payload.response.JwtResponse;
import com.kevin.activitytracker.payload.response.MessageResponse;
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		if (Boolean.TRUE.equals(userRepository.existsByUsername(signUpRequest.getUsername()))) {
			return ResponseEntity
					.badRequest()
					.body(new MessageResponse(USER_ALREADY_TAKEN_ERROR));
		}

		if (Boolean.TRUE.equals(userRepository.existsByEmail(signUpRequest.getEmail()))) {
			return ResponseEntity
					.badRequest()
					.body(new MessageResponse(EMAIL_ALREADY_USED_ERROR));
		}
